...
<body>
    ...
    <section>
        ...
        <form action="#" method="post">
            <div class="search-bg">
                <input type="text" name="name" class="search-stuff" id="searchstf" placeholder="Search flashcard..."></div>
                <div id="output"></div>
        </form>
        ...
        <script type="text/javascript">
            ...
            $("#searchstf").keypress(function(){
                ...
                url:'search.php',
                data:{
                    name:$("#searchstf").val(), option:"flashcard"
                },
        ...
        <div class="subjects">
            <a href="flashcardSubject.php?subject=Bahasa%20Malaysia" class="bm"><i class="fa-solid fa-book"></i></a>
            <a href="flashcardSubject.php?subject=English" class="eng"><i class="fa-solid fa-comments"></i></a>
            <a href="flashcardSubject.php?subject=Mathematics" class="mt"><i class="fa-solid fa-ruler-combined"></i></a>
            <a href="flashcardSubject.php?subject=Science" class="sc"><i class="fa-solid fa-flask"></i></a>
            <a href="flashcardSubject.php?subject=History" class="sej"><i class="fa-solid fa-ship"></i></a>
            <a href="flashcardSubject.php?subject=Pure%20Science" class="puresc"><i class="fa-solid fa-microscope"></i></a>
        </div>
    ...
    <section>
        <div class="list left">
            ...
            <?php 
            $query = "SELECT * FROM flashcard_t WHERE fc_sub = 'Bahasa Malaysia' LIMIT 2;";
        ...
        <div class="list right">
            ...
            <?php 
            $query = "SELECT * FROM flashcard_t WHERE fc_sub = 'English' LIMIT 2;";
            $results = mysqli_query($connection, $query);
            $count = mysqli_num_rows($results);
            if ($count != 0) {
                while ($row = mysqli_fetch_assoc($results)) {
        ...
        <div class="list left">
            ...
            <?php 
            $query = "SELECT * FROM flashcard_t WHERE fc_sub = 'Mathematics' LIMIT 2;";
            $results = mysqli_query($connection, $query);
            $count = mysqli_num_rows($results);
            if ($count != 0) {
                while ($row = mysqli_fetch_assoc($results)) {
        ...
        <div class="list right">
            ...
            <?php 
            $query = "SELECT * FROM flashcard_t WHERE fc_sub = 'Science' LIMIT 2;";
            $results = mysqli_query($connection, $query);
            $count = mysqli_num_rows($results);
            if ($count != 0) {
                while ($row = mysqli_fetch_assoc($results)) {
        ...
        <div class="list left">
            ...
            <?php 
            $query = "SELECT * FROM flashcard_t WHERE fc_sub = 'History' LIMIT 2;";
            $results = mysqli_query($connection, $query);
            $count = mysqli_num_rows($results);
            if ($count != 0) {
                while ($row = mysqli_fetch_assoc($results)) {
        ...
        <div class="list right">
            ...
            <?php 
            $query = "SELECT * FROM flashcard_t WHERE fc_sub = 'Pure Science' LIMIT 2;";
            $results = mysqli_query($connection, $query);
            $count = mysqli_num_rows($results);
            if ($count != 0) {
                while ($row = mysqli_fetch_assoc($results)) {
