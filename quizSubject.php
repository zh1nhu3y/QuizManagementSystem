...
Description    : Quiz of Selected Subject Page 
 -->
<?php
session_start();
include 'dbConn.php';
$subject = $_GET['subject'];
$query = "SELECT * FROM quiz_t INNER JOIN teacher_t ON quiz_t.tcr_id = teacher_t.tcr_id WHERE quiz_sub = '$subject'";
...
<body>
    ...
    <section>
        <div class="title">
            <h3 style="font-size: 35px;">Quiz</h3>
        ...
        ?>
                <div class="details">
                    ...
                    <a href="QuizFunction.php?quizID=<?php echo $row['quiz_id'];?>">Start Now</a>
                    <div class="clear"></div>
                </div>
                <?} else { ?>
        <?php }}
